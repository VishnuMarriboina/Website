...
//   function check() {
//     setError({
//       id: !id.trim() || !emailPattern.test(id) ? "Error" : "Ok",
//       password: !password.trim() || !intcod.test(password) ? "Error" : "Ok"
//     });
//   }

//   return (
//     <div className="w-full h-screen flex bg-local bg-no-repeat bg-center object-cover" style={{ backgroundImage: `url(${a3})`, backgroundSize: 'cover' }}>
//       <div className='text-center shadow-white shadow-inner mx-auto p-10 my-28'>
//         <h1 className='font-semibold text-3xl text-white mb-10'>Welcome to Order Management System</h1>

//         <label className="block text-xl font-medium text-white">
//           <span className="font-bold">Enter-ID:</span>
//           <input type="text" placeholder="mail-id" value={id} className="border text-black mx-4 my-4 rounded-2xl p-2"
...
//         <button className='bg-slate-400 font-semibold border rounded-lg px-60 py-3 mt-8 text-xl hover:bg-white' onClick={check}>LOGIN</button>
//       </div>
//     </div>
//   );
// }
